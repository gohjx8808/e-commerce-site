...
const StyledAutocompleteFormControl = styled(FormControl)<StyledAutocompleteFormControlProps>(
  ({ theme, lightbg }) => ({
    width: '100%',
    '& label': {
      color: !lightbg && theme.palette.common.white,
      '&.Mui-focused': {
        color: lightbg ? theme.palette.secondary.main : theme.palette.primary.main,
      },
    },
    '& .MuiOutlinedInput-root': {
      ...
      '&.Mui-focused fieldset': {
        borderColor: lightbg ? theme.palette.secondary.main : theme.palette.primary.main,
      },
